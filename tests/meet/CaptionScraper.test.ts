...
import { CAPTION_SELECTORS } from '@/meet/controls';
import type { Clock } from '@/utils/clock';
import type { TranscriptSegment } from '@/capture/types';

/**
 * Synthetic caption DOM matching the shape CAPTION_SELECTORS expects. Task 0

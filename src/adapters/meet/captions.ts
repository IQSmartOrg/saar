...
import { MEET_CONTROLS, resolveControl, type MatchStrategy } from '@/adapters/meet/join';
 ...
 * button was never clicked and nothing ever appeared.
 */
export const CAPTION_REGION = '[role="region"][aria-label*="aption" i]';

export function captionsAreOn(doc: Document, region: string = CAPTION_REGION): boolean {

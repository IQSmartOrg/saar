...
/**
 * Pure list logic for the meetings page: what state a meeting is in, how the
 * list is grouped, and what a search matches.
 *
...
export type { UiStatus as MeetingState } from '@/processing/status';
